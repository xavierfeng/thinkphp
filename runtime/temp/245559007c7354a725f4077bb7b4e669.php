<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\www\thinkphp\public/../application/admin/view/default/channel\sort.html";i:1496373782;s:73:"D:\www\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="main-title cf">
		<h2>
			导航排序 [ <a href="<?php echo url('index',array('pid'=>input('pid'))); ?>">返回列表</a> ]
		</h2>
	</div>
	<div class="sort">
...
<!-- 			<div class="sort_top">
			...
			<div class="sort_bottom">
				...
				<button class="sort_cancel btn btn-return" type="button" url="<?php echo url('index',array('pid'=>input('pid'))); ?>">返 回</button>
			</div>
		</form>
	</div>
