<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\www\thinkphp\public/../application/user/view/default/login\index.html";i:1511683839;s:72:"D:\www\thinkphp\public/../application/user/view/default/base\common.html";i:1511678516;s:69:"D:\www\thinkphp\public/../application/user/view/default/base\var.html";i:1496373782;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
  ...
  <div class="span12" style="margin-left: 200px;">
    <form class="login-form" action="" method="post">
      <div class="control-group">
        <label class="control-label" for="inputEmail"><h1>登录</h1></label>
        <div class="controls">
      ...
      <div class="control-group">
        <div class="controls">
          <input type="text" id="inputPassword" class="span3" placeholder="请输入5位验证码"  errormsg="请填写5位验证码" nullmsg="请填写验证码" datatype="*5-5" name="verify" style="width: 100%;height: 30px;">
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="control-group">
        <div class="controls">
          <button type="submit" class="btn" style="width: 100%;height: 40px;background: #1e74ff;color:white">登 陆</button>
        </div>
        还没有账号?<a href="/user/login/register.html">新用户注册</a>
      </div>
    </form>
  </div>
</section>
