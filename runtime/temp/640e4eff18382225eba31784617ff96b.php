<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\www\thinkphp\public/../application/user/view/default/login\index.html";i:1511955234;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
...
<div class="main">
  ...
  <div class="container-fluid">
    <form class="login-form" action="" method="post">
      ...
      <div class="control-group">
        <div class="controls">
          <input type="text" id="inputPassword" class="span3" placeholder="请输入5位验证码"  errormsg="请填写5位验证码" nullmsg="请填写验证码" datatype="*5-5" name="verify" style="width: 100%;height: 30px;border-radius:5px;">
        </div>
      </div>
      <div class="control-group">
