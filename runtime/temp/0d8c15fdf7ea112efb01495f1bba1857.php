<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\www\thinkphp\public/../application/admin/view/default/property\edit.html";i:1511677789;s:73:"D:\www\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="user" value="<?php echo (isset($info['user']) && ($info['user'] !== '')?$info['user']:''); ?>">
			</div>
		</div>
		<div class="form-item">
		...
		<div class="form-item">
			...
			<input type="hidden" name="odd" value='<?php echo (isset($info['odd']) && ($info['odd'] !== '')?$info['odd']:'property'.uniqid()); ?>'>
