    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <a href="<?php echo url('bactivityDetail?id='.$Bactivity['id']); ?>">
                ...
                <div class="col-xs-10">
                    <p class="title"><?php echo $Bactivity['title']; ?></p>
                    <p class="intro"><?php echo $Bactivity['description']; ?></p>
                    <p class="info">浏览次数:<?php echo $Bactivity['view']; ?><span class="pull-right"><?php echo time_format($Bactivity['create_time'] ); ?></span> </p>
                </div>
            </a>
        </div>
