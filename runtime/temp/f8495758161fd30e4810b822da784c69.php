...
<script>
    ...
    <tbody>
		...
		<tr>
			...
			<td><a data-id="<?php echo $vo['id']; ?>" href="<?php echo url('Article/edit?cate_id='.$vo['category_id'].'&id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a></td>
