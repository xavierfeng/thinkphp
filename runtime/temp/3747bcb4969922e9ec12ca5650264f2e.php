<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\www\thinkphp\public/../application/user/view/default/user\myproperty.html";i:1512036091;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <div class="col-xs-10">
                <h4 class="noticeDetailTitle"><strong>报修单号:<?php echo $property['odd']; ?></strong></h4>
                <p>
                    <strong>报修问题:<?php echo $property['question']; ?></strong>
                        <strong>处理情况:<?php echo !empty($property['status'])?"已处理":"未处理"; ?></strong>
                </p>
            </div>
        </div>
