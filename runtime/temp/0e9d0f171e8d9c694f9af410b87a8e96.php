<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\www\thinkphp\public/../application/admin/view/default/attribute\edit.html";i:1496373782;s:73:"D:\www\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="main-title cf">
		<h2><?php echo !empty($info['id'])?'编辑':'新增'; ?> [<?php echo get_model_by_id($info['model_id']); ?>] 属性 : <a href="<?php echo url('index','model_id='.$info['model_id']); ?>">返回列表</a></h2>
	</div>
	...
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<!-- 表单 -->
			<form id="form" action="<?php echo url('update'); ?>" method="post" class="form-horizontal doc-modal-form">
				<!-- 基础 -->
				<div id="tab1" class="tab-pane in tab1">
					<div class="form-item cf">
						<label class="item-label">字段名<span class="check-tips">（请输入字段名 英文字母开头，长度不超过30）</span></label>
						<div class="controls">
							<input type="text" class="text input-large" name="name" value="<?php if(isset($info['name'])): ?><?php echo $info['name']; endif; ?>">
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label">字段标题<span class="check-tips">（请输入字段标题，用于表单显示）</span></label>
						<div class="controls">
							<input type="text" class="text input-large" name="title" value="<?php if(isset($info['title'])): ?><?php echo $info['title']; endif; ?>">
						</div>
					</div>
					<div class="form-item cf">
					...
					<div class="form-item cf">
						...
						<div class="controls">
							<input type="text" class="text input-large" name="field" value="<?php if(isset($info['field'])): ?><?php echo $info['field']; endif; ?>" id="data-field">
						</div>
					</div>
					<div class="form-item cf">
						...
						<div class="controls">
							<label class="textarea input-large">
								<textarea name="extra"><?php if(isset($info['extra'])): ?><?php echo $info['extra']; endif; ?></textarea>
							</label>
						</div>
					</div>
					<div class="form-item cf">
						...
						<div class="controls">
							<input type="text" class="text input-large" name="value" value="<?php if(isset($info['value'])): ?><?php echo $info['value']; endif; ?>">
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label">字段备注<span class="check-tips">(用于表单中的提示)</span></label>
						<div class="controls">
							<input type="text" class="text input-large" name="remark" value="<?php if(isset($info['remark'])): ?><?php echo $info['remark']; endif; ?>">
						</div>
					</div>
					<div class="form-item cf">
                ...
                <div id="tab2" class="tab-pane tab2">
					...
					<!--</div>-->
					<div class="form-item cf">
						<label class="item-label">验证规则<span class="check-tips">（require|max:25）</span></label>
						<div class="controls">
							<input type="text" class="text input-large" name="validate_rule" value="<?php if(isset($info['validate_rule'])): ?><?php echo $info['validate_rule']; endif; ?>">
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label">出错提示<span class="check-tips">(名称必须|名称最多不能超过25个字符)</span></label>
						<div class="controls">
							<input type="text" class="text input-large" name="error_info" value="<?php if(isset($info['error_info'])): ?><?php echo $info['error_info']; endif; ?>">
						</div>
					</div>
					<div class="form-item cf">
					...
					<!--</div>-->
					<div class="form-item cf">
						<label class="item-label">自动完成规则<span class="check-tips">（填写验证函数或方法）</span></label>
						<div class="controls">
							<input type="text" class="text input-large" name="auto_rule" value="<?php if(isset($info['auto_rule'])): ?><?php echo $info['auto_rule']; endif; ?>">
						</div>
					</div>
					<div class="form-item cf">
				...
				<div class="form-item cf">
					...
					<div class="controls edit_sort_btn">
						<input type="hidden" name="id" value="<?php if(isset($info['id'])): ?><?php echo $info['id']; endif; ?>"/>
