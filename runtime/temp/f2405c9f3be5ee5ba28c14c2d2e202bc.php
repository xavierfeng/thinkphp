<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\www\thinkphp\public/../application/admin/view/default/model\generate.html";i:1496373782;s:73:"D:\www\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="tab-wrap">
		<div class="tab-content">
			<!-- 表单 -->
			<form id="form" action="<?php echo url('generate'); ?>" method="post" class="form-horizontal doc-modal-form">
				<!-- 基础 -->
				<div id="tab1" class="tab-pane in tab1">
					<div class="form-item cf">
						...
						<div class="controls">
							<select name="table">
								<?php if(is_array($tables) || $tables instanceof \think\Collection || $tables instanceof \think\Paginator): $i = 0; $__LIST__ = $tables;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tb): $mod = ($i % 2 );++$i;?>
					...
					<div class="form-item cf"> 
						<label class="item-label">操作类型<span class="check-tips"></span></label>
						<div class="controls">
							<label class="checkbox"><input class="auth_rules" name="copy" value="1" type="radio" checked>生成模型</label>
							<label class="checkbox"><input class="auth_rules" name="copy" value="2" type="radio">复制并生成模型</label> 
						</div>
					</div>
				</div>
				...
				<div class="form-item cf">
					...
					<div class="controls edit_sort_btn"> 
						<button class="btn submit-btn ajax-posts no-refresh" type="submit" target-form="form-horizontal">生 成</button>
