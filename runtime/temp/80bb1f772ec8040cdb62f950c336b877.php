<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\www\thinkphp\public/../application/admin/view/default/article\serviceEdit.html";i:1511755266;s:73:"D:\www\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="main-title">
		<h2>
			<?php echo !empty($info['id'])?'编辑':'新增'; ?>通知
		</h2>
	</div>
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<input type="hidden" name="member" value="<?=$_SESSION['twothink_admin']['user_auth']['username']?>">
