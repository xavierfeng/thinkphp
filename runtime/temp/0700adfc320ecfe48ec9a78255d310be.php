<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\www\thinkphp\public/../application/admin/view/default/article\examine.html";i:1496373782;s:73:"D:\www\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;s:78:"D:\www\thinkphp\public/../application/admin/view/default/article\sidemenu.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    <div class="tools auth-botton">
        ...
        <button url="<?php echo url('article/setStatus?status=1'); ?>" class="btn ajax-post" target-form="ids">审 核</button>
    </div>
    ...
    <tbody>
		...
		<tr>
			...
			<td><a href="<?php echo url('Article/edit?cate_id='.$vo['category_id'].'&id='.$vo['id']); ?>">编辑</a>
				<a href="<?php echo url('Article/setStatus?ids='.$vo['id'].'&status=1'); ?>" class="ajax-get">审核</a>
