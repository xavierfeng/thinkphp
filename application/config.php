...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'Q!U0.v4kHwX^/SPcd_n;6*7Bl>}Fyq?(ej"f1Wtg', //默认数据加密KEY
	'data_cache_key'=> 'Q!U0.v4kHwX^/SPcd_n;6*7Bl>}Fyq?(ej"f1Wtg',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'Q!U0.v4kHwX^/SPcd_n;6*7Bl>}Fyq?(ej"f1Wtg', //加密KEY
